...
function wrdsb_policy_tags_custom_taxonomy() {
	...
	$labels = array(
		'name'                       => _x( 'Policy Tags', 'Taxonomy General Name', 'wrdsb_policies' ),
		'singular_name'              => _x( 'Policy Category', 'Taxonomy Singular Name', 'wrdsb_policies' ),
		'menu_name'                  => __( 'Policy Tags', 'wrdsb_policies' ),
		'all_items'                  => __( 'All Policy Tags', 'wrdsb_policies' ),
		'parent_item'                => __( 'Parent Policy Category', 'wrdsb_policies' ),
		'parent_item_colon'          => __( 'Parent Policy Category:', 'wrdsb_policies' ),
		'new_item_name'              => __( 'New Policy Category Name', 'wrdsb_policies' ),
		'add_new_item'               => __( 'Add New Policy Category', 'wrdsb_policies' ),
		'edit_item'                  => __( 'Edit Policy Category', 'wrdsb_policies' ),
		'update_item'                => __( 'Update Policy Category', 'wrdsb_policies' ),
		'view_item'                  => __( 'View Policy Category', 'wrdsb_policies' ),
